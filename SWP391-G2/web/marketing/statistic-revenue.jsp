<%-- 
    Document   : statistic-revenue
    Created on : 16 thg 7, 2024, 05:28:20
    Author     : pna29
--%>
                                ...
                                <div style="padding: 10px 15px">
                                    <div class="d-flex justify-content-between p-md-1">
                                        ...
                                        <div style="text-align: end">
                                            <h4 style="color: #1B813A">All Products</h4>
                                            <p class="mb-0"></p>
                            ...
                            <div class="card">
                                <div style="padding: 10px 15px">
                                    <div class="d-flex justify-content-between p-md-1">
                                        ...
                                        <div style="text-align: end"> 
                                            <h4 style="color: #06439F;">Products Sold</h4>
                                            <p class="mb-0"></p>
                            ...
                            <div class="card">
                                <div style="padding: 10px 15px">
                                    <div class="d-flex justify-content-between p-md-1">
                                        ...
                                        <div style="text-align: end">
                                            <h4 style="color: #E94644;">Total Revenues</h4>
                                            <p class="mb-0"></p>
                            ...
                            <div class="card">
                                <div style="padding: 10px 15px">
                                    <div class="d-flex justify-content-between p-md-1">
                                        ...
                                        <div style="text-align: end">
                                            <h4 style="color: #06439F;">Total Deals</h4>
                                            <p class="mb-0"></p>
                                            <h2 class="h1 mb-0">${requestScope.totalDeals}</h2>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card">
                        <div class="card-header py-3">
                            <h3 class="mb-0 text-center">
                                <strong>Revenue Statistics by Weeks</strong>
                                <form id="f1" method="get" action="statisticRevenue">
                                    ...
                                    <button style="width: 100px; padding: 0" class="form-control" type="button" onclick="submitForm()">Xem</button>
                                </form>
                            </h3>
                        </div>
                        <div class="card-body">
            ...
            <div class="container pt-4">
                ...
                <section class="mb-4" id="doanhThuThang">
                    <div class="card">
                        <div class="card-header py-3">
                            <h3 class="mb-0 text-center">
                                <strong>Revenue Statistic by Months</strong>
                                <form id="f2" method="get" action="statisticRevenue">
