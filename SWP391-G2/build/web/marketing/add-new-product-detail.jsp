        ...
        <div class="container-fluid">
            ...
            <jsp:include page="../partials/navigation.jsp"></jsp:include>
                ...
                <div class="row" style="margin-right: 70px;  padding: 10px; border: 1.5px solid #000;">
                    ...
                    <form action="add-product-detail" id="productForm" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <input id="a" name="ima" hidden="" value="" type="text">
                            <div class="input-group image-preview-container">
                                <div class="input-group">
                                    <input type="file" name="img" class="form-control d-none image-preview" id="img" onchange="chooseFile(this)" accept="image/*" aria-describedby="inputGroupFileAddon04" aria-label="Upload">
                        ...
                        <div class="form-group row">
                            <div class="col-10">  
                                ...
                                <textarea name="detail" id="detail"  class="form-control" aria-label="With textarea"></textarea>
                        ...
                        <div class="form-group row d-flex col-10 justify-content-between">
                            <div class="col-3">
                                <div class="d-flex justify-content-around align-items-center">
                                    Price:
                                    <input type="text"  name="price" class="ms-2 form-control" id="price">     
                                </div>
                            ...
                            <div class="col-3">
                                <div class="d-flex justify-content-around align-items-center">
                                    Quantity:
                                    <input type="number" name="quantity" class="ms-2 form-control" id="quantity">
                                </div>
                        ...
                        <div class="d-flex justify-content-end">
                            <a class="btn btn-danger mx-2 border-secondary" href="../SWP391-G2/product-detail?proId=${proId}&cateId=${cateId}">Cancel</a>
                            <button type="submit" class="btn btn-primary" onclick="validateForm()">Add new Product</button>
                        </div>
                    </form>
                </div>         
            </div>
